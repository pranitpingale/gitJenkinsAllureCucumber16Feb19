        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return _regenerator2.default.awrap(_fsPromise2.default.outputFile(screenshotPath, base64Screenshot, 'base64'));

            case 4:
              _context.next = 6;
              return _regenerator2.default.awrap(_fsPromise2.default.exists(referencePath));
            ...
            case 25:
              ...
              _context.next = 28;
              return _regenerator2.default.awrap(_fsPromise2.default.remove(diffPath));
            ...
            case 31:
              ...
              _context.next = 34;
              return _regenerator2.default.awrap(_fsPromise2.default.outputFile(referencePath, base64Screenshot, 'base64'));
              ...
              return _regenerator2.default.awrap(new _promise2.default(function (resolve, reject) {
                ...
                png.on('end', function () {
                  ...
                  _promise2.default.resolve().then(function () {
                    return _fsPromise2.default.outputFile(filepath, buffer.toString('base64'), 'base64');
                  }).then(function () {
                    return resolve();
                  }).catch(reject);
                });

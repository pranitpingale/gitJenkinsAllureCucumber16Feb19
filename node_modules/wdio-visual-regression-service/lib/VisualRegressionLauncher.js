...
var VisualRegressionLauncher = function () {
  ...
  (0, _createClass3.default)(VisualRegressionLauncher, [{
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              this.widths = _lodash2.default.get(browser.options, 'visualRegression.widths');
    ...
    value: function wrapCommand(browser, type, command) {
      ...
      var resolutionKeySingle = browser.isMobile ? 'orientation' : 'width';
      var resolutionKeyPlural = browser.isMobile ? 'orientations' : 'widths';
      var resolutionMap = browser.isMobile ? _mapViewports.mapOrientations : _mapViewports.mapWidths;

      var viewportChangePauseDefault = this.viewportChangePause;
      var resolutionDefault = browser.isMobile ? this.orientations : this.widths;
      ...
      return function async() {
        ...
        var url, elementSelector, options, exclude, hide, remove, widths, orientations, resolutions, viewportChangePause, results;
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 2:
                ...
                exclude = options.exclude, hide = options.hide, remove = options.remove, widths = options.widths, orientations = options.orientations;
